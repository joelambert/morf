...
Morf.prototype.util={};Morf.prototype.util.toDash=function(d){d=d.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});return/^webkit/.test(d)?"-"+d:d};Morf.prototype.util.toCamel=function(d){return d.replace(/(\-[a-z])/g,function(a){return a.toUpperCase().replace("-","")})};

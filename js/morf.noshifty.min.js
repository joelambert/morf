...
Morf.prototype.util.toDash=function(b){b=b.replace(/([A-Z])/g,function(g){return"-"+g.toLowerCase()});return/^webkit/.test(b)?"-"+b:b};Morf.prototype.util.toCamel=function(b){return b.replace(/(\-[a-z])/g,function(g){return g.toUpperCase().replace("-","")})};

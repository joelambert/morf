...
o[parseInt(progress*100)+"%"]=frame}o["100%"]=n;this.css=createAnimationCSS(o,b);addKeyframeRule(this.css);for(rule in n)e.style[this.util.toCamel(rule)]=n[rule];e.addEventListener("webkitAnimationEnd",animationEndListener);e.style.webkitAnimationDuration=g.duration;e.style.webkitAnimationTimingFunction="linear";e.style.webkitAnimationName=b;g.debug&&window.console&&window.console.log&&console.log(createAnimationCSS(o,b))}};Morf.transition=function(e,a,c){return new Morf(e,a,c)};Morf.version="0.1";
